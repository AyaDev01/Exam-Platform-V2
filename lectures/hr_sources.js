...
const lectureData = {
  ...
  sources: [
    ...
    {
      order: 13,
      name: " المحاضرة 6: التدريب وتنمية المهارات",
      title: " المحاضرة 6: التدريب وتنمية المهارات",
      filePath: "pdfs/hr/المحاضرة السادسة-HR-2026 .pdf",
    },
    {
      order: 14,
      name: "📖 المحاضرة 7: الحوافز والأجور",
      title: "📖 المحاضرة 7: الحوافز والأجور",
      filePath: "pdfs/hr/المحاضرة السابعة-HR-2026.pdf",
    },
    {
      order: 15,
      name: "📖 المحاضرة 8: اليقظة الاجتماعية وإدارة النزاعات",
      title: "📖 المحاضرة 8: اليقظة الاجتماعية وإدارة النزاعات",
      filePath: "pdfs/hr/المحاضرة الثامنة-HR-2026.pdf",
    },
    {
        order:16,
        name:"المحاضرة 9: القيادة (Leadership)",
        title:"المحاضرة 9: القيادة (Leadership)",
        filePath:"pdfs/hr/HR-القيادة-فرقة 4-المحاضرة التاسعة.pdf",
    }
  ],
};
