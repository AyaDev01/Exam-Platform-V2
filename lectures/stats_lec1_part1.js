// stats_lec1_part1.js
const lectureData = {
  title: "📊 المحاضرة 1: مقدمة في الاحتمالات - الجزء الأول",
...
<div class="box">
  ...
  exam: {
    ...
    multipleChoice: [
      { question: "من العلماء الذين ساهموا في تأسيس علم الاحتمالات وتطويره في القرن الـ 17:", options: ["باسكال وبيرنولي", "نيوتن وأينشتاين", "الخوارزمي وجابر بن حيان", "أرسطو وأفلاطون"], correctIndex: "0" },
